rm(list=ls())
setwd("C:\\Users\\aditya joshi\\Edwisor\\satandar prediction analysis")
getwd()


#Reading the data
train = read.csv("C:\\Users\\aditya joshi\\Edwisor\\satandar prediction analysis\\train.csv", header = T)
test = read.csv("C:\\Users\\aditya joshi\\Edwisor\\satandar prediction analysis\\test.csv", header = T)
#Explore the data
str(train)
